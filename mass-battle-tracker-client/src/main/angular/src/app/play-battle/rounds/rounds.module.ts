...
@NgModule({
  declarations: [ObjectiveSelectionComponent, LeaderSelectionComponent, LeaderActionComponent, ConditionsCheckComponent, FirstMoveComponent, HighestInitCommanderPipe, CommandersPipe, StandingLeadersOfCommanderPipe],
  imports: [
    CommonModule,
    AppRoutingModule,
    ReactiveFormsModule,
